...
public class Slider {
	 ...
	 */
	public static String loadDataWho(DemolinkedtvApplication parent,FsTimeLine timeline, float start, float duration) {
		String body = "";
		int i = 1;
		if (timeline == null) {
	 ...
	 * @return html formatted layer
	 */
	public static String loadDataWhat(DemolinkedtvApplication parent,FsTimeLine timeline, float start, float duration) {
		String body = "";
		int i = 1;
		if (timeline == null) {
			System.out.println("timeline appears to be empty!");
	 ...
	 * @return html formatted layer
	 */
	public static String loadDataWhere(DemolinkedtvApplication parent,FsTimeLine timeline, float start, float duration) {
		String body = "";
		int i = 1;
		if (timeline == null) {
			System.out.println("timeline appears to be empty!");
	 ...
	 * @return html formatted layer
	 */
	public static String loadDataChapter(DemolinkedtvApplication parent, FsTimeLine timeline) {
		String body = "";		
	 ...
	 */
	public static String loadDataBookmark(Screen s,DemolinkedtvApplication parent,FsTimeLine timeline) {
		String body = "";
	 ...
	 * @return html formatted data
	 */
	public static String loadDataShared(Screen s,DemolinkedtvApplication parent,FsTimeLine timeline) {
		String body = "";
		UserManager um = parent.getUserManager();
		String username = s.getUserName();
		if (username==null) {
	 ...
	 * @return html formatted data
	 */
	public static String loadDataJoined(DemolinkedtvApplication parent,FsTimeLine timeline) {
		String body = "";
		UserManager um = parent.getUserManager();
	 ...
	 * @return html formatted data
	 */
	public static String loadDataChat(DemolinkedtvApplication parent,FsTimeLine timeline) {
		String body = "";
