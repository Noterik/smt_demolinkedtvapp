 ...
 * shows the video on the main screen while the second screen
 * shows related information about the current moment in video
 * divided into four slider layers, "who", "what", "where" and chapters.
 * Users can select items from the seconds screen to read a short
 * abstract about it or rotate their device to go to a website with 
 * more information.
 ...
 * 
 */
public class DemolinkedtvApplication extends Html5Application {
	...
	public DemolinkedtvApplication(String id) {
		super(id); 
		System.out.println("DEMOLINKEDTV STARTED");
	}
	
	public DemolinkedtvApplication(String id, String remoteReciever) {
		super(id, remoteReciever); 
		System.out.println("DEMOLINKEDTV STARTED 2");
	}
